...
namespace DatabaseToolSuite.Controls
{
    ...
    public class PeriodCompoBox: Base.PickerControlBase
    {
        ...
        public PeriodCompoBox(): base(new PeriodPopupForm())
        {
            this.SuspendLayout();
            ...
            //PeriodBox.ValueChanged += new System.EventHandler<ExcelAnalyzer.Arm.PeriodEventArgs>(this.PeriodBox_ValueChanged);
        ...
        protected override void OnPreviewKeyDown(PreviewKeyDownEventArgs e)
        {
            ...
            else if (e.KeyCode == Keys.Up)
            {
                ...
                {
                    state = StateType.SelectMonth;
                    this.Value = Arm.Period.Create(this.Value.Year, this.Value.PreviouseMonth.Month);
                }
                else if (state == StateType.SelectMonth)
                {
                    this.Value = Arm.Period.Create(this.Value.Year, this.Value.PreviouseMonth.Month);
            ...
            else if (e.KeyCode == Keys.Down)
            {
                ...
                {
                    state = StateType.SelectMonth;
                    this.Value = Arm.Period.Create(this.Value.Year, this.Value.NextMonth.Month);
                }
                 else if (state == StateType.SelectMonth)
                {
                    this.Value = Arm.Period.Create(this.Value.Year, this.Value.NextMonth.Month);
        ...
        private void GetDecimal(Arm.Period period)
        {
        ...
        private Arm.Period GetPeriod()
        {
            return Arm.Period.Create(FirstDecimal, LastDecimal, YearDecimal_01, YearDecimal_02, YearDecimal_03, YearDecimal_04);
        }
