...
namespace DatabaseToolSuite.Dialogs
{
	class EsnsiDialog : DialogBase
	{
		...
		public long RegionCode
		{
			get
			{
				return esnsiOkatoComboBox.SelectedItem != null
					? esnsiOkatoComboBox.SelectedItem.Ter
					: 0;
			}
		}
		...
		public string Phone
		{
			get { return esnsiPhoneTextBox.Text; }
		}

		public string Email
		{
			get { return esnsiEmailTextBox.Text; }
		}

		public string Address
		{
			get { return esnsiAddressTextBox.Text; }
		}
		...
		public int OkatoCode
		{
			...
			{
				return esnsiOkatoComboBox.SelectedItem != null
					? int.Parse(esnsiOkatoComboBox.SelectedItem.Okato)
					: 0;
			}
		}
		...
		public int Code
		{
			get { return (int)esnsiCodeNumericTextBox.Value; }
		}

		public string Autokey
		{
			get { return esnsiAutokeyTextBox.Text; }
		}
			...
			: base()
		{
			...
			esnsiOkatoComboBox.InitializeSource(Services.FileSystem.Repository.MainDataSet.okato);
			...
			esnsiRegionTextBox.Text =
				esnsiOkatoComboBox.SelectedItem != null
					? esnsiOkatoComboBox.SelectedItem.Name2
					: string.Empty;
			...
			esnsiCodeNumericTextBox.Text = DataRow.IscodeNull()
				? string.Empty
