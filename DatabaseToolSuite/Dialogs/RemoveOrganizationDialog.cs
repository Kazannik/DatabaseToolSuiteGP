...
namespace DatabaseToolSuite.Dialogs
{
	internal class RemoveOrganizationDialog : DialogBase
	{
		...
		private void DetailsUpdate()
		{
			...
			listView1.Items.Add("Вид органа").SubItems.Add(DataRow.authority_id.ToString("00") + " - " + Services.FileSystem.Repository.MainDataSet.authority.GetName(DataRow.authority_id));
			listView1.Items.Add("ОКАТО").SubItems.Add(DataRow.okato_code + " - " + Services.FileSystem.Repository.MainDataSet.okato.GetName(DataRow.okato_code));
